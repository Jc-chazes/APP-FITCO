...
export class SchedulePage {
  ...
  ionViewDidEnter() {
    this.ga
      .startTrackerWithId('UA-76827860-10')
      .then(() => {
      ...
      error => {
        ...
        switch (err.title) {
          ...
          case 'ERROR_DB_BODY':
            ...
            message= 'Se ha alcanzado el límite de reservas para su menbresía';
            break;
        }
  ...
  getRequirements() {
    this.disciplinesService.getDisciplines().subscribe((response: any) => {
      this.selectDisciplines = response;
    });

    this.personalService.getPersonal().subscribe((response: any) => {
      const arr = [];
    ...
    this.roomsService.getRooms().subscribe((response: any) => {
      this.selectRooms = response;
    });

    if (this.shareBD) {
      this.establishmentsService.getAll().subscribe((response: any) => {
  ...
  getCurrencyCode() {
    this.establishmentsService.getEstablishmentById().subscribe((success: any) => {
  ...
  selectEstablishment() {
    ...
    this.disciplinesService.getDisciplines(this.establishmentIdSelected).subscribe((response: any) => {
      this.selectDisciplines = response;
    });

    this.roomsService.getRooms(this.establishmentIdSelected).subscribe((response: any) => {
      this.selectRooms = response;
    });
  ...
  selectDiscipline() {
    if (this.disciplineIdSelected && this.disciplineIdSelected != '') {
      this.personalService.getPersonalByDiscipline(this.disciplineIdSelected).subscribe((response: any) => {
